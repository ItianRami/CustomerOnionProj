...
using CustomerOnionProj.Infrastructure.Mapping;
using CustomerOnionProj.Persistence;
using CustomerOnionProj.Service.Contract;
using CustomerOnionProj.Service.Implementation;
...
namespace CustomerOnionProj.Infrastructure.Extension
{
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            ...
            serviceCollection.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer("Data Source=.;Initial Catalog=OnionDb;Trusted_Connection=True;MultipleActiveResultSets=true"));
        }
